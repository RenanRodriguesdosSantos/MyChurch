          ...
          <v-form ref="visitaForm">
            <v-row class="text-lg-center" >
                <v-col cols="12" lg="6" md="6" >
                    <v-text-field type="date" label="Data da visita" v-model="visita.data" outlined :rules="requiredRule"></v-text-field>
                </v-col>
                <v-col cols="12" lg="6" md="6" >
                ...
                <v-col lg="6" md="6" cols="12">
                    <v-textarea label="Descrição da visita" type="text"
                    hint="Descreva o que deve ser reaizado na visita"
                    v-model="visita.descricao" outlined :rules="requiredRule"></v-textarea>
                </v-col>
